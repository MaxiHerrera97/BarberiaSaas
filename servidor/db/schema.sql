...
CREATE TABLE IF NOT EXISTS tenant_settings (
  ...
  theme_bg_main CHAR(7) NOT NULL DEFAULT '#090A0D',
  theme_bg_elevated CHAR(7) NOT NULL DEFAULT '#12141A',
  theme_bg_soft CHAR(7) NOT NULL DEFAULT '#171A21',
  theme_text_main CHAR(7) NOT NULL DEFAULT '#F6F5F1',
  theme_text_muted CHAR(7) NOT NULL DEFAULT '#B7B8BE',
  theme_brand CHAR(7) NOT NULL DEFAULT '#D9A13D',
  theme_brand_soft CHAR(7) NOT NULL DEFAULT '#F2C879',
  theme_brand_deep CHAR(7) NOT NULL DEFAULT '#9D6F1D',
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS services (
  ...
  booking_prepayment_mode ENUM('none', 'total', 'percent', 'fixed') NOT NULL DEFAULT 'none',
  booking_prepayment_percent TINYINT UNSIGNED NULL,
  booking_prepayment_fixed_ars INT UNSIGNED NULL,
  is_active TINYINT(1) NOT NULL DEFAULT 1,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS appointments (
  ...
  booking_paid_ars_snapshot INT UNSIGNED NOT NULL DEFAULT 0,
  booking_due_ars_snapshot INT UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS appointment_payment_intents (
  ...
  service_total_ars INT UNSIGNED NOT NULL DEFAULT 0,
  remaining_ars INT UNSIGNED NOT NULL DEFAULT 0,
  prepayment_mode ENUM('none', 'total', 'percent', 'fixed') NOT NULL DEFAULT 'none',
  prepayment_percent_snapshot TINYINT UNSIGNED NULL,
  prepayment_fixed_ars_snapshot INT UNSIGNED NULL,
  customer_name VARCHAR(120) NOT NULL,
  customer_phone VARCHAR(20) NOT NULL,
